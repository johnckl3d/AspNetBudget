...
namespace MeetupAPI.Controllers
{
    ...
    public class MeetupController : ControllerBase
    {
        ...
        public MeetupController(BudgetContext budgetContext, IMapper mapper, IAuthorizationService authorizationService)
        {
        ...
        {
            var meetups = _budgetContext.Meetups.Include(m => m.Location).ToList();
        ...
        {
            var meetup = _budgetContext.Meetups
        ...
        public ActionResult Post([FromBody]MeetupDto model)
        {
            ...
            _budgetContext.Meetups.Add(meetup);
